<template>
    <section class="add-container">
                    ...
                    <div class="field-container">
                        ...
                        <div class="content">
                            <el-scrollbar class="scrollbar" ref="scrollTree">
                                <el-tree ref="tree" :props="defaultProps" :data="collections" node-key="tableName" :default-expanded-keys="expandedKeys" show-checkbox :filter-node-method="filterNode" @check-change="handleCheckChange" />
                            </el-scrollbar>
                        </div>
                    </div>
                </el-tab-pane>
        ...
        <el-dialog title="预览表单" :visible.sync="dialogVisible" :close-on-click-modal="false" append-to-body width="65%">
...
export default {
    ...
    methods: {
        ...
        initTree() {
            ...
            let tableKeys = [];
            this.currForms.itemList.forEach(item => {
                if (!keys.includes(item.table)) {
                    tableKeys.push(item.table);
                }
            })
            this.expandedKeys = tableKeys;
        },
        checkedKeys() {
            let keys = [];
            //debugger
