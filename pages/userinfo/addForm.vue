        ...
        <el-scrollbar class="scrollbar" ref="scrollbar">
            <el-form size="mini" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
                ...
                <el-form-item label="密码" prop="password">
                    <el-input v-model="ruleForm.password" type="password" :disabled="!setPasswrod" clearable show-password autocomplete="off"
                        style="width: 145px;" />
                ...
                <el-form-item>
                    <el-button type="primary" @click="submitForm" :icon="loading?'el-icon-loading':''" :disabled="loading">{{editUser?'编辑保存':'立即创建'}}</el-button>
