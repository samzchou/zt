    ...
    <section class="home-container">
        ...
        <div class="tools">
            <div>
                ...
                <div class="canlan">
                    <el-date-picker size="mini" v-model="weekDay" type="week" :picker-options="{'firstDayOfWeek': 1}" format="yyyy年 第 WW 周" placeholder="选择周"
                        @change="setDay" />
                </div>
                <div class="text" v-if="weekList.length">{{setWeekTitle}}, {{weekDay && weekDay.getFullYear()}}</div>
            </div>
            <div>
                <el-button size="mini" icon="el-icon-time" type="primary" @click="saveData" style="margin-right:20px;">保存</el-button>
                <el-button-group>
