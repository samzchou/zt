<template>
	<section class="work-container">
		<div class="header">
			<div>
				<div style="margin-right:10px">
					<el-date-picker size="mini" v-model="currDate" type="month" placeholder="选择月"
						@change="changeCurrDate" style="width:120px" />
				</div>
		...
		<div class="tables">
			<el-table size="mini" :data="tableData.slice((query.page-1)*query.size, query.page*query.size)"
				:cell-class-name="setCellStyle" :header-cell-class-name="setCellStyle">
				...
				<el-table-column v-for="(day,index) in daysData" :prop="String(index)" :key="index" width="50"
					align="center">
